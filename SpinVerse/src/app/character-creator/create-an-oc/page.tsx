...
export default function CreateanOCWheelPage() {
    ...
    <>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <div className="flex gap-2 text-xs font-bold uppercase tracking-wider mb-6 opacity-75">
          ...
          <span>/</span>
          <span className="text-retro-orange">Create an OC</span>
        </div>
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            "Spin this wheel to generate a random background, race, or class for your next original character."
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t-3 border-retro-navy dark:border-cream pt-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-black font-display mb-6 text-retro-navy dark:text-cream">
              Why Use the Create an OC Wheel?
            </h2>
            <div className="prose dark:prose-invert font-medium text-base space-y-4">
              <p>
                "Creating a new original character (OC) from scratch can be intimidating. Our Create an OC Wheel acts as a creative prompt, giving you a base archetype to build upon. Perfect for writers, artists, and tabletop roleplayers."
              </p>
              <p>
              ...
              <p>
                Explore other tools in this category such as [Boy or Girl OC Spinner](/character-creator/boy-or-girl-oc), [Gacha Character Generator Wheel](/character-creator/gacha-character-generator), [Hair Color Wheel](/character-creator/hair-color) or check out the main <Link href="/games" className="text-retro-orange underline font-bold">Games Hub</Link> directory.
              </p>
            </div>
          </div>
        ...
        <section className="neo-card p-8 bg-white dark:bg-retro-navy mb-12">
          ...
          <div className="space-y-6 font-medium">
            {[{"q":"How can I expand on the class/race selected?","a":"Once you select an archetype, spin the hair, eye, and clothing style wheels to build out the full design."}].map((faq, idx) => (
              <div key={idx}>
