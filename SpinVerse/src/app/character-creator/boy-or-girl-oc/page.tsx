...
export default function BoyorGirlOCSpinnerPage() {
    ...
    <>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <div className="flex gap-2 text-xs font-bold uppercase tracking-wider mb-6 opacity-75">
          ...
          <span>/</span>
          <span className="text-retro-orange">Boy or Girl OC Spinner</span>
        </div>
        ...
        <section className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black font-display tracking-tight text-retro-navy dark:text-cream mb-4">
            "Boy or Girl OC Spinner"
          </h1>
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            "Stuck on deciding the gender identity of your next character? Spin the pointer to decide instantly."
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t-3 border-retro-navy dark:border-cream pt-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-black font-display mb-6 text-retro-navy dark:text-cream">
              Why Use the Boy or Girl OC Spinner?
            </h2>
            <div className="prose dark:prose-invert font-medium text-base space-y-4">
              <p>
                "If you find yourself repeatedly creating characters of the same gender, break the habit by using the Boy or Girl OC Spinner. It introduces unbiased selection into your character design workflow."
              </p>
              <p>
              ...
              <p>
                Explore other tools in this category such as [Create an OC Wheel](/character-creator/create-an-oc), [Gacha Character Generator Wheel](/character-creator/gacha-character-generator), [Hair Color Wheel](/character-creator/hair-color) or check out the main <Link href="/games" className="text-retro-orange underline font-bold">Games Hub</Link> directory.
              </p>
            </div>
          </div>
        ...
        <section className="neo-card p-8 bg-white dark:bg-retro-navy mb-12">
          ...
          <div className="space-y-6 font-medium">
            {[{"q":"Can I add custom gender identities?","a":"Yes! Simply use the editor panel to add, remove, or rename the options to match your character world."}].map((faq, idx) => (
              <div key={idx}>
