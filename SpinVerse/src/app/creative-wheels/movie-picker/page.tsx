...
export default function MoviePickerWheelPage() {
    ...
    <>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <div className="flex gap-2 text-xs font-bold uppercase tracking-wider mb-6 opacity-75">
          ...
          <span>/</span>
          <span className="text-retro-orange">Movie Picker</span>
        </div>
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            "Resolve what to watch tonight by spinning movie genres."
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t-3 border-retro-navy dark:border-cream pt-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-black font-display mb-6 text-retro-navy dark:text-cream">
              Why Use the Movie Picker Wheel?
            </h2>
            <div className="prose dark:prose-invert font-medium text-base space-y-4">
              <p>
                "Can't decide what film to put on Netflix? Spin this movie picker to pick a movie genre and save hours of searching."
              </p>
              <p>
              ...
              <p>
                Explore other tools in this category such as [Drawing Idea Wheel](/creative-wheels/drawing-idea-wheel), [Arrow Spin Wheel](/creative-wheels/arrow-spin), [TBR Prompts Wheel](/creative-wheels/tbr-prompts) or check out the main <Link href="/games" className="text-retro-orange underline font-bold">Games Hub</Link> directory.
              </p>
            </div>
          </div>
        ...
        <section className="neo-card p-8 bg-white dark:bg-retro-navy mb-12">
          ...
          <div className="space-y-6 font-medium">
            {[{"q":"Can I add specific movie titles?","a":"Yes! Replace genres with your actual watchlist names in the editor."}].map((faq, idx) => (
              <div key={idx}>
