...
export default function ExtremeTruthorDareWheelPage() {
    ...
    <>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <div className="flex gap-2 text-xs font-bold uppercase tracking-wider mb-6 opacity-75">
          ...
          <span>/</span>
          <span className="text-retro-orange">Extreme Truth or Dare</span>
        </div>
        ...
        <section className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black font-display tracking-tight text-retro-navy dark:text-cream mb-4">
            "Extreme Truth or Dare Wheel"
          </h1>
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            "Spin for highly challenging, intensive, and crazy truths and dares."
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t-3 border-retro-navy dark:border-cream pt-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-black font-display mb-6 text-retro-navy dark:text-cream">
              Why Use the Extreme Truth or Dare Wheel?
            </h2>
            <div className="prose dark:prose-invert font-medium text-base space-y-4">
              <p>
                "Push the limits of your party game night. This selection is designed for close friends who aren't afraid of funny embarrassment."
              </p>
              <p>
              ...
              <p>
                Explore other tools in this category such as [Truth or Dare Wheel](/party-games/truth-or-dare), [Adult Truth or Dare Wheel](/party-games/adult-truth-or-dare), [Spin the Bottle Wheel](/party-games/spin-the-bottle) or check out the main <Link href="/games" className="text-retro-orange underline font-bold">Games Hub</Link> directory.
              </p>
            </div>
          </div>
        ...
        <section className="neo-card p-8 bg-white dark:bg-retro-navy mb-12">
          ...
          <div className="space-y-6 font-medium">
            {[{"q":"Are these safe to perform?","a":"Yes, they are safe but highly entertaining. Always skip any dare you feel uncomfortable with."}].map((faq, idx) => (
              <div key={idx}>
