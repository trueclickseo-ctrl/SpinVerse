      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            "Spin the wheel to get classic Truth or Dare prompts for kids, teens, and families."
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t-3 border-retro-navy dark:border-cream pt-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-black font-display mb-6 text-retro-navy dark:text-cream">
              Why Use the Truth or Dare Wheel?
            </h2>
            <div className="prose dark:prose-invert font-medium text-base space-y-4">
              <p>
                "Never run out of ideas for Truth or Dare. Spin this interactive spinner to assign a fun question or funny action to the players."
              </p>
              <p>
              ...
              <p>
                Explore other tools in this category such as [Extreme Truth or Dare Wheel](/party-games/extreme-truth-or-dare), [Adult Truth or Dare Wheel](/party-games/adult-truth-or-dare), [Spin the Bottle Wheel](/party-games/spin-the-bottle) or check out the main <Link href="/games" className="text-retro-orange underline font-bold">Games Hub</Link> directory.
              </p>
            </div>
          </div>
        ...
        <section className="neo-card p-8 bg-white dark:bg-retro-navy mb-12">
          ...
          <div className="space-y-6 font-medium">
            {[{"q":"Is it clean for families?","a":"Yes, this wheel contains lighthearted prompts perfect for family gatherings."}].map((faq, idx) => (
              <div key={idx}>
