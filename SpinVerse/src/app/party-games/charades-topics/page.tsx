...
export default function CharadesTopicsWheelPage() {
    ...
    <>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <div className="flex gap-2 text-xs font-bold uppercase tracking-wider mb-6 opacity-75">
          ...
          <span>/</span>
          <span className="text-retro-orange">Charades Topics</span>
        </div>
        ...
        <section className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black font-display tracking-tight text-retro-navy dark:text-cream mb-4">
            "Charades Topics Wheel"
          </h1>
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            "Get hilarious and creative topics for family charades games."
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t-3 border-retro-navy dark:border-cream pt-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-black font-display mb-6 text-retro-navy dark:text-cream">
              Why Use the Charades Topics Wheel?
            </h2>
            <div className="prose dark:prose-invert font-medium text-base space-y-4">
              <p>
                "Generate quick acting ideas instantly. Settle disputes about what characters or actions should be acted out."
              </p>
              <p>
        ...
        <section className="neo-card p-8 bg-white dark:bg-retro-navy mb-12">
          ...
          <div className="space-y-6 font-medium">
            {[{"q":"Are the topics hard?","a":"They are balanced for both kids and adults to enjoy."}].map((faq, idx) => (
              <div key={idx}>
