...
export default function PercentWheelSpinnerPage() {
    ...
    <>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <div className="flex gap-2 text-xs font-bold uppercase tracking-wider mb-6 opacity-75">
          ...
          <span>/</span>
          <span className="text-retro-orange">Percent Spinner</span>
        </div>
        ...
        <section className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black font-display tracking-tight text-retro-navy dark:text-cream mb-4">
            "Percent Wheel Spinner"
          </h1>
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            "Spin to get a random percentage value between 10% and 100%."
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t-3 border-retro-navy dark:border-cream pt-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-black font-display mb-6 text-retro-navy dark:text-cream">
              Why Use the Percent Wheel Spinner?
            </h2>
            <div className="prose dark:prose-invert font-medium text-base space-y-4">
              <p>
                "Decide split values, discount levels, or game probabilities randomly with this math utility."
              </p>
              <p>
              ...
              <p>
                Explore other tools in this category such as [Color Wheel Spinner](/generators/color-wheel), [Number Wheel Spinner](/generators/number-wheel), [Alphabet Wheel Spinner](/generators/alphabet-wheel) or check out the main <Link href="/games" className="text-retro-orange underline font-bold">Games Hub</Link> directory.
              </p>
            </div>
          </div>
        ...
        <section className="neo-card p-8 bg-white dark:bg-retro-navy mb-12">
          ...
          <div className="space-y-6 font-medium">
            {[{"q":"Can I add smaller steps?","a":"Yes, add steps like \"1%\", \"5%\", or \"99%\" to the editor."}].map((faq, idx) => (
              <div key={idx}>
