...
export default function NumberWheelSpinnerPage() {
    ...
    <>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <div className="flex gap-2 text-xs font-bold uppercase tracking-wider mb-6 opacity-75">
          ...
          <span>/</span>
          <span className="text-retro-orange">Number Spinner</span>
        </div>
        ...
        <section className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black font-display tracking-tight text-retro-navy dark:text-cream mb-4">
            "Number Wheel Spinner"
          </h1>
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            "Configurable number range wheel. Replaces standard random number spinner variants."
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t-3 border-retro-navy dark:border-cream pt-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-black font-display mb-6 text-retro-navy dark:text-cream">
              Why Use the Number Wheel Spinner?
            </h2>
            <div className="prose dark:prose-invert font-medium text-base space-y-4">
              <p>
                "Configure your minimum and maximum range bounds, and let the wheel dynamically rebuild itself. A clean replacement for multiple static number range keywords."
              </p>
              <p>
              ...
              <p>
                Explore other tools in this category such as [Color Wheel Spinner](/generators/color-wheel), [Percent Wheel Spinner](/generators/percent-wheel), [Alphabet Wheel Spinner](/generators/alphabet-wheel) or check out the main <Link href="/games" className="text-retro-orange underline font-bold">Games Hub</Link> directory.
              </p>
            </div>
          </div>
        ...
        <section className="neo-card p-8 bg-white dark:bg-retro-navy mb-12">
          ...
          <div className="space-y-6 font-medium">
            {[{"q":"How high can the range go?","a":"You can set it up to 100 or higher, though numbers under 50 render best on screen."}].map((faq, idx) => (
              <div key={idx}>
