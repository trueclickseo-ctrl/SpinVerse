...
export default function FastFoodRestaurantsWheelPage() {
    ...
    <>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <div className="flex gap-2 text-xs font-bold uppercase tracking-wider mb-6 opacity-75">
          ...
          <span>/</span>
          <span className="text-retro-orange">Fast Food Restaurants</span>
        </div>
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            "Spin to pick between popular fast-food chains for a quick lunch."
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t-3 border-retro-navy dark:border-cream pt-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-black font-display mb-6 text-retro-navy dark:text-cream">
              Why Use the Fast Food Restaurants Wheel?
            </h2>
            <div className="prose dark:prose-invert font-medium text-base space-y-4">
              <p>
                "Too tired to cook and can't choose a drive-thru? Spin for an instant fast food pick."
              </p>
              <p>
              ...
              <p>
                Explore other tools in this category such as [What to Eat Wheel](/food-wheels/what-to-eat), [Snacks Wheel](/food-wheels/snacks), [Dessert Wheel](/food-wheels/dessert) or check out the main <Link href="/games" className="text-retro-orange underline font-bold">Games Hub</Link> directory.
              </p>
            </div>
          </div>
        ...
        <section className="neo-card p-8 bg-white dark:bg-retro-navy mb-12">
          ...
          <div className="space-y-6 font-medium">
            {[{"q":"Can I customize it to nearby stores?","a":"Yes, remove chains that aren't available in your city."}].map((faq, idx) => (
              <div key={idx}>
