...
export default function WhattoEatWheelPage() {
    ...
    <>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        ...
        <div className="flex gap-2 text-xs font-bold uppercase tracking-wider mb-6 opacity-75">
          ...
          <span>/</span>
          <Link href="/food-wheels" className="hover:text-retro-orange">Food Wheels</Link>
          <span>/</span>
          <span className="text-retro-orange">What to Eat</span>
        </div>
        ...
        >
          <ArrowLeft className="w-4 h-4" /> Back to Food Wheels
        </Link>
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            "Solve the dinner debate instantly by picking a random food cuisine."
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t-3 border-retro-navy dark:border-cream pt-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-black font-display mb-6 text-retro-navy dark:text-cream">
              Why Use the What to Eat Wheel?
            </h2>
            <div className="prose dark:prose-invert font-medium text-base space-y-4">
              <p>
                "Stop asking \"What do you want to eat?\" and letting it drag on. Spin the wheel and let fate decide your dinner cuisine."
              </p>
              <p>
              ...
              <p>
                Explore other tools in this category such as [Fast Food Restaurants Wheel](/food-wheels/fast-food-restaurants), [Snacks Wheel](/food-wheels/snacks), [Dessert Wheel](/food-wheels/dessert) or check out the main <Link href="/games" className="text-retro-orange underline font-bold">Games Hub</Link> directory.
              </p>
            </div>
          </div>
        ...
        <section className="neo-card p-8 bg-white dark:bg-retro-navy mb-12">
          ...
          <div className="space-y-6 font-medium">
            {[{"q":"Can I add local restaurants?","a":"Yes! Replace generic cuisines with your local spots in the custom editor."}].map((faq, idx) => (
              <div key={idx}>
